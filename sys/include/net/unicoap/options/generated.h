...
/**
 * @brief Retrieves the `OSCORE` option, if present
 * @memberof unicoap_options_t
 *
 * @param[in] options Options to read from
 * @param[out] undefined Pointer to value variable as buffer of UTF-8 code units
 *
 * @returns Size of option value in bytes on success, negative error number otherwise
 * @retval `-ENOENT` Option not found
 * @retval `-EBADOPT` Option corrupted
 */
static inline ssize_t unicoap_options_get_oscore(
    const unicoap_options_t* options,
    const char** undefined
) {
    return unicoap_options_get(options, UNICOAP_OPTION_OSCORE, (const uint8_t**)undefined);
} /* generated by 'getterUTF8' template */

/**
 * @brief Sets the `OSCORE` option
 * @memberof unicoap_options_t
 *
 * @param[in,out] options Options to write to
 * @param[in] undefined `OSCORE` value as buffer of UTF-8 code units
 * @param length Number of UTF-8 code units in @p undefined, excluding null-terminator (if present)
 *   in bytes without potential null-terminator
 *
 * @returns Zero on success, negative error number otherwise
 * @retval `-ENOBUFS` Options buffer lacks sufficient capacity to set option
 *
 * @pre @p undefined size must not exceed 255 bytes
 */
static inline ssize_t unicoap_options_set_oscore(
    unicoap_options_t* options,
    char* undefined, size_t length
) {
    assert(length <= 255);
    return unicoap_options_set(options, UNICOAP_OPTION_OSCORE, (uint8_t*)undefined, length);
} /* generated by 'setterUTF8' template */

/**
 * @brief Sets the `OSCORE` option from null-terminated string
 * @memberof unicoap_options_t
 *
 * @param[in,out] options Options to write to
 * @param[in] undefined `OSCORE` value as buffer of UTF-8 code units, must be null-terminated
 *
 * @returns Zero on success, negative error number otherwise
 * @retval `-ENOBUFS` Options buffer lacks sufficient capacity to set option
 *
 ...
 *
 * Uses `strlen` to calculate the number of code units.
 * @see @ref unicoap_options_t::unicoap_options_set_oscore
 */
static inline ssize_t unicoap_options_set_oscore_string(
    unicoap_options_t* options,
    char* undefined
) {
    return unicoap_options_set_oscore(options, undefined, strlen(undefined));
} /* generated by 'setterUTF8NullTerminated' template */

/**
 * @brief Removes the `OSCORE` option, if present
 * @memberof unicoap_options_t
 *
 * @param[in,out] options Options to write to
 *
 * @returns Zero on success, negative error number otherwise
 */
static inline int unicoap_options_remove_oscore(unicoap_options_t* options)
{
    return unicoap_options_remove(options, UNICOAP_OPTION_OSCORE);
} /* generated by 'remove' template */
/** @} */ /* OSCORE */
